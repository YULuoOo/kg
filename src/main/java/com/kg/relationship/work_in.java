...
public class work_in extends BaseEntity {
    ...
    public com.kg.node.person getPerson() {
        return person;
    }

    public void setPerson(com.kg.node.person person) {
        this.person = person;
    }

    public com.kg.node.company getCompany() {
        return company;
    }

    public void setCompany(com.kg.node.company company) {
